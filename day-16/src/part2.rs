...
fn count_top_corner(base_grid: Grid) -> usize {
    let mut count = 0;
    let len: isize = base_grid.tiles[0].len() as isize;
    for i in 0..len {
...
fn count_bottom_corner(base_grid: Grid) -> usize {
    let mut count = 0;
    let len: isize = base_grid.tiles[0].len() as isize;
    for i in 0..len {
        let mut grid = base_grid.clone();
...
fn count_left_corner(base_grid: Grid) -> usize {
    let mut count = 0;
    let len: isize = base_grid.tiles.len() as isize;
    for i in 0..len {
        let mut grid = base_grid.clone();
...
fn count_right_corner(base_grid: Grid) -> usize {
    let mut count = 0;
    let len: isize = base_grid.tiles.len() as isize;
    for i in 0..len {
        let mut grid = base_grid.clone();
